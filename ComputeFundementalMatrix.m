function [ F ] = ComputeFundementalMatrix( image1, image2 )
%COMPUTEFUNDEMENTALMATRIX Summary of this function goes here
...
F = estimateFundamentalMatrix(matchedImage1, matchedImage2);
